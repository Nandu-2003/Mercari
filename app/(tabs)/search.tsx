...
const styles = StyleSheet.create({
  ...
  pressableButton: {
    backgroundColor: "#2196F3", // Give it a background color
    padding: 10,
    borderRadius: 5,
    margin: 10,
    width: 200, // Explicitly give it a width
    alignItems: "center", // Center text inside the button
  },
  buttonText: {
    color: "#fff", // Ensure the text is white or visible
    fontSize: 16,
  },
});
